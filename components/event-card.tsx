      ...
      <div className="relative w-full max-w-md mx-auto" style={{ perspective: 1000 }}>
        ...
        >
          ...
          {!isFlipped && (
            <div
              ref={cardRef}
              className="relative glass rounded-3xl p-8 border-indigo-500/50 overflow-hidden group"
            >
          ...
          {isFlipped && (
            <div 
              className="relative glass rounded-3xl px-8 py-12 border-indigo-500/50 overflow-hidden bg-gradient-to-br from-blue-500/30 via-indigo-500/20 to-cyan-500/20 min-h-96 flex flex-col justify-between items-center"
